...
scapy — the only third-party dependency
...
Path to the .pcap / .pcapng file (required, positional)
...
Number of top items shown per section (top talkers, conversations, ports, SNI, JA3, etc.)
...
Save the full text report to FILE
...
Save a machine-readable JSON report to FILE
